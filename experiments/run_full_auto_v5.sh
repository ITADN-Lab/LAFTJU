...
SAVE_DIR="./results"
DATA_DIR="./dataset"
LOG="./results/experiment_log_v5.txt"
SEEDS="42 123 456"
...
# =============================================================================
log "--- Phase 3: LAKTJU 3-seed runs (with V5 fix: eps=1e-4 matching ATJU, no diagonal clip, L2 weight decay) ---"
...
feishu "🎉 V5 All experiments complete" "purple" "$SUMMARY"

log "============================================"
log "ALL V5 EXPERIMENTS COMPLETE"
log "============================================"
