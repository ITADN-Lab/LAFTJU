...
SAVE_DIR="./results"
DATA_DIR="./dataset"
LOG="./results/experiment_log_v4.txt"
SEEDS="42 123 456"
...
# =============================================================================
log "--- Phase 3: LAKTJU 3-seed runs (with convergence fix: rebound=0.01, c_l=1.0, diagonal clipes) ---"
...
feishu "🎉 V4 All experiments complete" "purple" "$SUMMARY"

log "============================================"
log "ALL V4 EXPERIMENTS COMPLETE"
log "============================================"
