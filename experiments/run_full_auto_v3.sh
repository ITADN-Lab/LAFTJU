...
SAVE_DIR="./results"
DATA_DIR="./dataset"
LOG="./results/experiment_log_v3.txt"
SEEDS="42 123 456"
...
# =============================================================================
log "--- Phase 3: LAKTJU 3-seed runs (with perf fixes) ---"
...
feishu "🎉 V3 All experiments complete" "purple" "$SUMMARY"

log "============================================"
log "ALL V3 EXPERIMENTS COMPLETE"
log "============================================"
