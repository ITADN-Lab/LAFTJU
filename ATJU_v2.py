    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                grad_diff = grad_TJU - exp_avg_grad  # Current parameter gradient minus the previously stored gradient
                ...
                delta_term = (grad_diff.div_(prev_update_norm)  # Normalize grad_diff
                    ...
                    prev_update_sq).sum()  # Multiply approximate Hessian approx_hessian by squared previous update prev_update_sq and sum
                # The difference of the two terms gives delta_term
                ...
                prev_update.copy_(new_update)  # Save the current update new_update into prev_update for the next iteration
